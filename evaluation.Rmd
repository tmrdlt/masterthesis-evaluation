...
intro <- read_excel("data/data_prepared.xlsx", sheet="intro")
colors <- c("#4a7c59", "#68b0ab", "#8fc0a9", "#c8d5b9" )
plot1 <- intro %>% select(c(1)) %>%
  ggplot(aes(x="", fill= factor(tools, levels=c("Trello", "Jira", "Others")))) +
  geom_bar(stat="count") +
  coord_polar("y") + 
  xlab(" ") + ylab("") +
  theme_minimal() + 
...
View(intro)
plot2 <- intro %>% select(c(2)) %>%
  ggplot(aes(x="", fill= fct_infreq(frequency))) +
  geom_bar(stat="count") +
  coord_polar("y") + 
  xlab(" ") + ylab("") +
  theme_minimal() + 
...
plot3 <- intro %>% select(c(3)) %>%
  ggplot(aes(x="", fill=areas )) +
  geom_bar(stat="count") +
  coord_polar("y") + 
  xlab(" ") + ylab("") +
  theme_minimal() + 
